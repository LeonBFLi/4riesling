                ...
                script {
                    ...
                    catchError {
                        dir(tempDir) {
                            ...
                            sh 'sudo cd /tmp/jenkins_workstation; sudo chmod -R 755 /tmp/jenkins_workstation/*; sudo scp -o StrictHostKeyChecking=no -rp /tmp/jenkins_workstation/* root@172.31.31.255:~/project'
                        }
